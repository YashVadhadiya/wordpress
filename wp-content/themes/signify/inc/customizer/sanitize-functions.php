<?php
/**
 * Signify Theme Options Sanitization Functions
 *
 * @package Signify
 */
 ...
 */
function signify_sanitize_select( $input, $setting ) {
 ...
 */
function signify_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function signify_sanitize_post( $input ) {
 ...
 */
function signify_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since 1.0.0
 */
function signify_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function signify_sanitize_number_range( $number, $setting ) {
